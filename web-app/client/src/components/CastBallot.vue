<template>
  <div class="posts">
    <h1>Cast Ballot</h1>
    <input type="radio" id="one" value="red" v-model="picked">
    <label for="one">Mr. Red</label>
    <br>
    <input type="radio" id="two" value="blue" v-model="picked">
    <label for="two">Mr. Blue</label>
    <br>
    <input type="radio" id="two" value="green" v-model="picked">
    <label for="two">Mr. Green</label>
    <br>
    <input type="radio" id="two" value="pink" v-model="picked">
    <label for="two">Mr. Pink</label>
    <br>
    <input type="radio" id="two" value="yellow" v-model="picked">
    <label for="two">Mr. Yellow</label>
    <br>
    <br>
    <span v-if="picked">
      Picked:
